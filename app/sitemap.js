...
export default async function sitemap() {
  const staticRoutes = ['', '/annuaire', '/leaderboard', '/trending', '/new', '/decouverte', '/stats', '/status', '/documentation', '/templates', '/faq', '/cgu', '/reglement', '/a-propos', '/changelog', '/partenaires'].map((path) => ({
    url: `${SITE_URL}${path}`,
